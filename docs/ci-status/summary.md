...
|---|---|---|---|---:|---|
| `dev-azure` | 2026-06-24 22:12Z | `0a7d882` | ⏭️ skipped | 0% (9) | 1h |

## Code quality

| Workflow | Last run | Outcome | Metrics |
|---|---|---|---|
| `validate-dsl-definitions` | 2026-06-24 20:37Z | 🟠 error | failed_jobs=0, skipped_jobs=0 |
