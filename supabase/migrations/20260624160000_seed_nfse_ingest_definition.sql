...
values (
  ...
  "name": "nfse-ingest",
  "version": "1.0.0",
  "description": "Automatically ingest Brazilian NFS-e: list new invoices from the source API, extract fiscal fields with an LLM (Azure gpt-5.4), and persist them. Dedup is handled by nfse_list_new (skips already-extracted invoices before any model call).",
  "steps": {
    "sequence": {
      "steps": [
        {
